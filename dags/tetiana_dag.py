...
mysql_connection_id = "mysql_connection_tetiana"
...
with DAG(
    ...
    create_table_task = MySqlOperator(
        ...
        sql="""
        CREATE TABLE IF NOT EXISTS neo_data.tetiana_medal_counts (
    ...
    count_bronze_task = MySqlOperator(
        ...
        mysql_conn_id=mysql_connection_id,
        sql="""
           INSERT INTO neo_data.tetiana_medal_counts (medal_type, medal_count)
           SELECT 'Bronze', COUNT(*)
    ...
    check_last_record_task = SqlSensor(
        ...
        sql="""
                    WITH count_in_medals AS (
                        select COUNT(*) as nrows FROM neo_data.tetiana_medal_counts
